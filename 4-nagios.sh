...
find / -group nagios | xargs chgrp 119
find / -user nagios | xargs chown 119
groupmod -g 119 nagios
usermod -u 119 nagios

# 4.2. nagios-agent
yum -y install nrpe
find / -group nrpe | xargs chgrp 118
find / -user nrpe | xargs chown 118
groupmod -g 118 nrpe
usermod -u 118 nrpe
...
command[check_process]=/usr/lib64/nagios/plugins/check_procs -C $ARG4$ -w $ARG1$ -c $ARG2$ -s $ARG3$
__EOT__
